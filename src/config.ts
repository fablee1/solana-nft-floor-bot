...
export const exchangesToUse = ["SA"] // DE for digital eyes, SA for solanart
export const cronTime = "*/30 * * * *" // Set your preferred cron schedule
...
export const MAXIMUM_PRICE_PER_BUY = 3 // Price in SOL
